...
export default class App extends Component {
    ...
    handleDelClick1 = (index) => {
        ...
        let oldlistImmutable = fromJS(this.state.list)
        console.log(oldlistImmutable)

        let newlistImmutable = oldlistImmutable.splice(index,1)

        console.log(newlistImmutable)
        this.setState({
            list:newlistImmutable.toJS()
        })
    }
