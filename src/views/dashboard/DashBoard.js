...
import {isShowObserver} from '../../mobx/store'
...
export default class DashBoard extends Component {
    ...
    componentDidMount() {
        this.unscibe = autorun(()=>{
            // console.log(isShowObserver.get())

            this.setState({
                isAllShow:isShowObserver.get()
            })
        })
    }
    ...
    render() {
        ...
        return (
            <Layout>
                {/* 自定义的sidemenu */}
                {
                    this.state.isAllShow && <SideMenu></SideMenu>
                }
                <Layout className="site-layout">
                    {
                        this.state.isAllShow && <TopHeader></TopHeader>
                    }
                    <Content
